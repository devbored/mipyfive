...
class TestController(unittest.TestCase):
    ...
    test_ctrl_lui = test_controller(asm2binU("lui", "x6", str(randImm20)),
        AluOp.ADD.value, 1, 0, 0, Mem2RegCtrl.FROM_ALU.value, AluASrcCtrl.FROM_ZERO.value, 
            AluBSrcCtrl.FROM_IMM.value, 0)
    ...
    test_ctrl_beq = test_controller(asm2binB("beq", "x23", str(randImm12), "x11"),
        AluOp.XOR.value, 0, 0, 0, Mem2RegCtrl.FROM_ALU.value, AluASrcCtrl.FROM_RS1.value, 
            AluBSrcCtrl.FROM_RS2.value, 1)
    ...
    test_ctrl_blt = test_controller(asm2binB("blt", "x14", str(randImm12), "x21"),
        AluOp.SLT.value, 0, 0, 0, Mem2RegCtrl.FROM_ALU.value, AluASrcCtrl.FROM_RS1.value, 
            AluBSrcCtrl.FROM_RS2.value, 1)
    ...
    test_ctrl_bltu = test_controller(asm2binB("bltu", "x9", str(randImm12), "x4"),
        AluOp.SLTU.value, 0, 0, 0, Mem2RegCtrl.FROM_ALU.value, AluASrcCtrl.FROM_RS1.value, 
            AluBSrcCtrl.FROM_RS2.value, 1)
